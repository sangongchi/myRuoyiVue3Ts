    ...
    /** @lends OpenSeadragon.ControlDock.prototype */ {
      ...
      takeScreenshot: function () {
        ...
        var downloadFunction = function () {
          ...
          var Canvas = null
          if (
            viewer.screenshotInstance.showOptions &&
            viewer.scalebarInstance &&
            document.getElementById("screenshotDrawScalebar").checked
          ) {
      ...
      menuUpdate: function () {
        ...
        document.getElementById("screenshotTextMessage").innerHTML =
          "Size of download: " +
          Math.round(this.screenshotWidth) +
          "x" +
          Math.round(this.screenshotHeight)
      },
    }
  )
})(OpenSeadragon)
