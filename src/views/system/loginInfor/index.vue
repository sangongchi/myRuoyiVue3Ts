    ...
    <el-card shadow="hover">
      <template #header>
        <el-row :gutter="10" class="mb8">
          ...
          <el-col :span="1.5">
            <el-button type="danger" icon="Delete" @click="handleClean" v-hasPermi="['monitor:logininfor:remove']">
              清空
            </el-button>
          </el-col>
          <el-col :span="1.5">
          ...
          <el-col :span="1.5">
            <el-button type="warning" icon="Download" @click="handleExport" v-hasPermi="['monitor:logininfor:export']">
              导出
            </el-button>
          </el-col>
...
const getList = async () => {
  loading.value = true
  const res = (await list(proxy?.addDateRange(queryParams.value, dateRange.value))) as any
