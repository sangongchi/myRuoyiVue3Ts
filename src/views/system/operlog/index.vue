    ...
    <el-card shadow="hover">
      <template #header>
        <el-row :gutter="10" class="mb8">
          ...
          <el-col :span="1.5">
            <el-button type="warning" icon="Download" @click="handleExport" v-hasPermi="['monitor:operlog:export']">
              导出
            </el-button>
          </el-col>
        ...
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item label="返回参数：">
              <div class="break-all">{{ form.jsonResult }}</div>
            </el-form-item>
          </el-col>
          <el-col :span="6">
...
const data = reactive<{ form: OperLogForm; queryParams: OperLogQuery }>({
  form: {
    operId: undefined,
    tenantId: undefined,
    title: '',
...
const getList = async () => {
  loading.value = true
  const res = await getOperLogList(proxy?.addDateRange(queryParams.value, dateRange.value))
